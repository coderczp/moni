...
public class MemMapUtil {
     ...
     * 
     */
    public final static void checkRangeState(int index, int size, boolean isClose) {
        if (isClose) {
     ...
     * 
     */
    public final static void checkRangeState(int index, int index2, int size, boolean isClose) {
        if (isClose) {
            throw new RuntimeException("memory map is destory");
        }
